...
### 2026-06-05 — Compactação periódica do CRDT state
Documentos Automerge crescem com o histórico de patches. Implementar job background que roda `Automerge.save()` + garbage collection de patches com mais de 30 dias, mantendo apenas o snapshot atual. Evita crescimento ilimitado do `crdt_state` no banco.
